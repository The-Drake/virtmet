...
<img src='images/calendar-day.png' width=16 height=16 border=0><b>&nbsp;$lgEVENTS</b>
...
</td><td width='50%'><img src='images/gear.png' width=16 height=16 border=0><b>&nbsp;$lgLOGGERINFO</b>
<br><hr align=left size=1 width='90%'>
...
system('uname -nmi');
echo "<br>";
system("cat /proc/cpuinfo | grep 'Processor' | head -n 1");
echo "
